...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<RecommendResourceRecommendCreator>[] is M) {
      return data.map<RecommendResourceRecommendCreator>((
          Map<String, dynamic> e) =>
          RecommendResourceRecommendCreator.fromJson(e)).toList() as M;
    }
    if (<TopArtistEntity>[] is M) {
      return data.map<TopArtistEntity>((Map<String, dynamic> e) =>
          TopArtistEntity.fromJson(e)).toList() as M;
    }
    if (<TopArtistArtists>[] is M) {
      return data.map<TopArtistArtists>((Map<String, dynamic> e) =>
          TopArtistArtists.fromJson(e)).toList() as M;
    }
    if (<LikeListEntity>[] is M) {
      return data.map<LikeListEntity>((Map<String, dynamic> e) =>
          LikeListEntity.fromJson(e)).toList() as M;
    }
    if (<QrcodeKeyEntity>[] is M) {
      return data.map<QrcodeKeyEntity>((Map<String, dynamic> e) =>
          QrcodeKeyEntity.fromJson(e)).toList() as M;
    }
    ...
    if (<UserInfoAccount>[] is M) {
      return data.map<UserInfoAccount>((Map<String, dynamic> e) =>
          UserInfoAccount.fromJson(e)).toList() as M;
    }
    if (<UserInfoProfile>[] is M) {
      return data.map<UserInfoProfile>((Map<String, dynamic> e) =>
          UserInfoProfile.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (RecommendResourceRecommend).toString(): RecommendResourceRecommend
        .fromJson,
    (RecommendResourceRecommendCreator)
        .toString(): RecommendResourceRecommendCreator.fromJson,
    ...
    (UserPlaylistPlaylistCreator).toString(): UserPlaylistPlaylistCreator
        .fromJson,
  };
