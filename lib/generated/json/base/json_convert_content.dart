...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<CommonApiResponse>[] is M) {
      return data.map<CommonApiResponse>((Map<String, dynamic> e) => CommonApiResponse.fromJson(e))
          .toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (CommonApiResponse).toString(): CommonApiResponse.fromJson,
